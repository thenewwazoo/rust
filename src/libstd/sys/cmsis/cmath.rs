...
// This approach is cribbed directly from the wasm32 target, as the problem is similar. Normally
// these functions would be provided by the C stdlib. They still potentially could be if you could
// link them in, but we have no way to provide them now. Presumably they could, at some point, be
// replaced with pure Rust implementations or tuned asm.
